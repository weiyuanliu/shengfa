...
<SCRIPT src="style/blue/js/submit.js" type="text/javascript"></SCRIPT>
    ...
    <div class="html1">
     <div class="listrightb">
                      <%if Action="Left" then%>
                        <!--#include file="info/RequestLeft1.asp"-->
                      <%else%>
                          <!--#include file="info/zxdg_left1.asp"-->
                      <%End if%>
       </div>
     </div>
   <div>
