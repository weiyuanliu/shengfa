...
%>
        ...
        <td align="right" nowrap><a href="MessageEdit.asp?Result=Add">添加留言信息</a><font color="#0000FF">&nbsp;|&nbsp;</font><a href="MessageList.asp" onClick='changeAdminFlag("留言信息列表")'>查看留言列表</a><font color="#0000FF">&nbsp;|&nbsp;</font><a href="SetSite.asp#Message" target="mainFrame" onClick='changeAdminFlag("网站信息设置")'>设置自动审核</a></td>
      </tr>
    </table>      </td>    
  </tr>
</table>
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
    ...
    <td width="88" bgcolor="#8DB5E9" align='center'><font color="#FFFFFF"><strong>留言地区</strong></font></td>
    <td width="193" nowrap bgcolor="#8DB5E9" align='center'><font color="#FFFFFF"><strong>留言标题</strong></font></td>
    <td width="194" nowrap bgcolor="#8DB5E9" align='center'><span class="STYLE1">地区</span></td>
    <td width="49" align="center" nowrap bgcolor="#8DB5E9" align='center'><strong><font color="#FFFFFF"><strong>标记</strong></font></strong></td>
    <td width="100" nowrap bgcolor="#8DB5E9" align='center'><strong><font color="#FFFFFF">留言时间</font></strong></td>
    <td width="52" nowrap bgcolor="#8DB5E9" align='center'><font color="#FFFFFF"><strong>审核</strong></font></td>
    <td width="118" nowrap bgcolor="#8DB5E9" align='center'><strong><font color="#FFFFFF">回复时间</font></strong></td>
    <td colspan="2" width="76" nowrap bgcolor="#8DB5E9" align='center'><strong><font color="#FFFFFF">操作</font></strong>
...
'-----------------------------------------------------------
  if(idcount>0 and sqlid<>"") then'如果记录总数=0,则不处理
    ...
    while(not rs.eof)'填充数据到表格
      ...
      Response.Write "<td width='100' nowrap><a href='Msghf.asp?id="&Rs("ID")&"'>恢复留言</a>&nbsp;<a href='MessageEdit.asp?Result=Modify&ID="&rs("ID")&"' onClick='changeAdminFlag(""查看回复订单信息"")'><font color='#330099'>查看</font></a></td>" & vbCrLf
    ...
    Response.Write "<td colspan='2' nowrap  bgcolor='#EBF2F9' align='center'>"
	if Instr(session("AdminPurview"),"|304,")<>0 then 
    Response.Write "<input name='submitDelSelect' type='button' class='button'  id='submitDelSelect' value='删除所选' onClick='ConfirmDel(""您真的要删除这些留言信息吗？"");'>"
	end if
    ...
    response.write "<tr><td height='50' align='center' colspan='11' nowrap  bgcolor='#EBF2F9'>暂无留言信息</td></tr>"
  end if
'-----------------------------------------------------------
'-----------------------------------------------------------
  Response.Write "<tr>" & vbCrLf
