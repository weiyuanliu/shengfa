...
function PlaceFlag()
  if Result="" then
    Response.Write "会员：列表&nbsp;->&nbsp全部"
  else
    Response.Write "会员：列表&nbsp;->&nbsp;检索&nbsp;->&nbsp;注册时间[<font color='red'>"&StartDate&"至"&EndDate&"</font>]，关键字[<font color='red'>"&Keyword&"</font>]"
  end if
end function  
%>
  ...
  <tr>
    <td height="36" align="center" nowrap  bgcolor="#EBF2F9"><table width="100%" border="0" cellspacing="0">
      <tr>
        ...
        <td align="right" nowrap> 操作：<a href="MemEdit.asp?Result=Add" onClick='changeAdminFlag("添加新会员")'>添加会员</a><font color="#0000FF">&nbsp;|&nbsp;</font><a href="MemList.asp" onClick='changeAdminFlag("查看所有会员")'>查看所有会员</a></td>
      </tr>
    </table>      </td>    
  </tr>
</table>
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  <form action="DelContent.asp?Result=Members" method="post" name="formDel" >
    <tr>
      ...
      <td width="66" nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>登录名</strong></font></td>
      <td bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>单位名称</strong></font></td>
      <td width="56" nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong><strong>所属组别</strong></strong></font></td>
      <td width="116" nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong><font color="#FFFFFF"><strong>注册时间</strong></font></strong></font></td>
      <td width="116" nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>最近登录时间</strong></font></td>
      <td width="52" nowrap bgcolor="#8DB5E9"><strong><font color="#FFFFFF">登录次数</font></strong></td>
...
'-----------------------------------------------------------
  if(idcount>0 and sqlid<>"") then'如果记录总数=0,则不处理
    ...
    response.write "<tr><td height='50' align='center' colspan='10' nowrap  bgcolor='#EBF2F9'>暂无网站会员</td></tr>"
  end if
'-----------------------------------------------------------
'-----------------------------------------------------------
  Response.Write "<tr>" & vbCrLf
