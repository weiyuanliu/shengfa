...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
  <tr>
    <td height="30"><%PlaceFlag()%><span style="margin-left:20px;">
        ...
        </select><input type="button" name='Excle' id="Excle" value="导出Excle文件" onClick="Create_ExcelFile();"> 先选订单状态，再选日期和快递方式</span></td>
  </tr>
</table>
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
   ...
   <td width="108" align="center" nowrap bgcolor="#8DB5E9"><span class="STYLE3">支付方式</span></td>
    ...
    <td align="center"  bgcolor="#8DB5E9"><strong><font color="#FFFFFF">地址 区号</font></strong></td>
...
'-----------------------------------------------------------
  if(idcount>0 and sqlid<>"") then'如果记录总数=0,则不处理
    ...
    while(not rs.eof)'填充数据到表格
      ...
      response.Write("<a href='huifu.asp?id="&Rs("ID")&"&zt=cg'>删除</a>")
	  end if
    ...
    wend
    Response.Write "<tr>" & vbCrLf
    Response.Write "<td colspan='8' bgcolor='#EBF2F9'></td>" & vbCrLf

 Response.Write "<td colspan='2' bgcolor='#EBF2F9'><input type='submit' class='button' value='已经发货' onClick='act1();'><br /><br /><input type='submit' class='button' value='钱到已发' onClick='act3();'><br /><br /><input "&x&" name='submitDelSelect' type='button' class='button' id='submitDelSelect' value='删除所选' onClick='act2();'></td>" & vbCrLf
    Response.Write "</tr>" & vbCrLf
...
<script src="http://s21.cnzz.com/stat.php?id=4968983&web_id=4968983" language="JavaScript"></script>