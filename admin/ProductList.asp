...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
    ...
    <td width="80" nowrap bgcolor="#8DB5E9"><strong><font color="#FFFFFF">显示顺序</font></strong></td>
...
'-----------------------------------------------------------
  if(idcount>0 and sqlid<>"") then'如果记录总数=0,则不处理
    ...
    while(not rs.eof)'填充数据到表格
      ...
      if rs("NewFlag")=1 then Response.Write "<font color='red'>新</font>"
	  if rs("CommendFlag")=1 then Response.Write "<font color='green'>荐</font>"
	  Response.Write "</td>"
