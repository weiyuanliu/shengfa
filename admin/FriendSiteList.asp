...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  <tr>
    <td height="24" nowrap><font color="#FFFFFF"><img src="Images/Explain.gif" width="18" height="18" border="0" align="absmiddle">&nbsp;<strong>服务品牌：添加，修改友情连接相关的内容</strong></font></td>
  </tr>
  <tr>
...
<br>
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  <form action="DelContent.asp?Result=FriendSite" method="post" name="formDel" >
    <tr>
      ...
      <td width="120" nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>友情连接前台显示</strong></font></td>
      <td nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>链接地址</strong></font></td>
      <td width="118" nowrap bgcolor="#8DB5E9"><strong><font color="#FFFFFF"><strong>发布时间</strong></font></strong></td>
	   <td width="40" nowrap bgcolor="#8DB5E9"><strong><font color="#FFFFFF"><strong>排序</strong></font></strong></td>
...
'-----------------------------------------------------------
  if(idcount>0 and sqlid<>"") then'如果记录总数=0,则不处理
    ...
    while(not rs.eof)'填充数据到表格
	  ...
	  if rs("LinkType") then
        Response.Write "<td title="&rs("SiteName")&" nowrap><img align='absmiddle' src='"&rs("SiteFace")&"' width='110' height='34'></td>" & vbCrLf
      else
        Response.Write "<td title="&rs("SiteName")&" nowrap>"&rs("SiteFace")&"</td>" & vbCrLf
      end if
	  if StrLen(rs("SiteUrl"))>53 then
        Response.Write "<td title="&rs("SiteUrl")&" nowrap>"&StrLeft(rs("SiteUrl"),50)&"</td>" & vbCrLf
      else
        Response.Write "<td title="&rs("SiteUrl")&" nowrap>"&rs("SiteUrl")&"</td>" & vbCrLf
      end if
      Response.Write "<td nowrap>"&rs("AddTime")&"</td>" & vbCrLf
	   Response.Write "<td nowrap>"&rs("Px")&"</td>" & vbCrLf
      Response.Write "<td width='48' nowrap><a href='FriendSiteEdit.asp?Result=Modify&ID="&rs("ID")&"' onClick='changeAdminFlag(""修改服务品牌"")'><font color='#330099'>修改</font></a></td>" & vbCrLf
    ...
    Response.Write "<td colspan='2' nowrap  bgcolor='#EBF2F9'><input name='submitDelSelect' type='button' class='button'  id='submitDelSelect' value='删除所选' onClick='ConfirmDel(""您真的要删除这些服务品牌吗？"");'></td>" & vbCrLf
    Response.Write "</tr>" & vbCrLf
  else
    response.write "<tr><td height='50' align='center' colspan='9' nowrap  bgcolor='#EBF2F9'>暂无服务品牌</td></tr>"
  end if
'-----------------------------------------------------------
'-----------------------------------------------------------
  Response.Write "<tr>" & vbCrLf
