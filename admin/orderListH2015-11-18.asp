...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  <tr>
    <td height="24" ><font color="#FFFFFF"><img src="Images/Explain.gif" width="18" height="18" border="0" align="absmiddle">&nbsp;<strong>订单回收站：查看，修改，回复订单信息相关的内容</strong></font></td>
  </tr>
  <tr>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
  <tr>
	...
	<form name="formxian" method="post" action="OrderListH.asp" style="margin:0px;display:inline;">
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
    ...
    <td width="80" align="center" bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>订购者</strong></font></td>
    <td width="80" align="center" nowrap bgcolor="#8DB5E9"><span class="STYLE3">删除原因</span></td>
...
'if session("AdminId") = 62 or session("AdminId") = 1 then
	...
	Telh = Left(rs("Tel"),0)&"********"&right(rs("Tel"),3)
	  ...
	  if Instr(session("AdminPurview"),"|314,")=0 then
	   ...
	   del="<a href='huifu.asp?id="&Rs("ID")&"'>恢复订单</a>"
	  end if	
...
'屏蔽删除回收站
if session("AdminId") = 62 or session("AdminId") = 1 then
 Response.Write "<td colspan='3' align='center'  bgcolor='#EBF2F9'><input "&x&" name='submitDelSelect' type='button' class='button'  id='submitDelSelect' value='删除所选' onClick='ConfirmDel(""本次将彻底删除订单？"");'></td>" & vbCrLf
end if
    Response.Write "</tr>" & vbCrLf
