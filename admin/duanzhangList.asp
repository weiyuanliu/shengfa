...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
    ...
    <td width="88" bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>网名</strong></font></td>
	<td width="88" bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>性别</strong></font></td>
    <td nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>留言标题</strong></font></td>
    <td width="28" nowrap bgcolor="#8DB5E9"><strong><font color="#FFFFFF">地址</font></strong></td>
    <td width="58" nowrap bgcolor="#8DB5E9"><strong><font color="#FFFFFF">电话</font></strong></td>
    <td width="59" nowrap bgcolor="#8DB5E9"><strong><font color="#FFFFFF">留言时间</font></strong></td>
    <td width="28" nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>审核</strong></font></td>
    <td width="118" nowrap bgcolor="#8DB5E9"><strong><font color="#FFFFFF">邮箱</font></strong></td>
  ...
  if(idcount>0 and sqlid<>"") then'如果记录总数=0,则不处理
    ...
    while(not rs.eof)'填充数据到表格
      ...
      Response.Write "<td nowrap>"&Guest(rs("MemID"),rs("Linkman"))&"</td>" & vbCrLf
	    Response.Write "<td nowrap>"&Rs("sex")&"</td>" & vbCrLf
	  if StrLen((rs("MesName")))>41 then
        Response.Write "<td title="&rs("MesName")&" nowrap>"&StrLeft(rs("MesName"),39)&"</td>" & vbCrLf
      else
        Response.Write "<td title="&rs("MesName")&" nowrap>"&rs("MesName")&"</td>" & vbCrLf
      end if 
     
	 
     
	    Response.Write "<td nowrap>"&Rs("address")&"</td>" & vbCrLf
	 
         Response.Write "<td nowrap>"&Rs("Telephone")&"</td>" & vbCrLf
      ...
      Response.Write "<td nowrap>"&rs("email")&"</td>" & vbCrLf
      Response.Write "<td width='48' nowrap><a href='duanzhangEdit.asp?Result=Modify&ID="&rs("ID")&"' onClick='changeAdminFlag(""查看"")'><font color='#330099'>查看</font></a></td>" & vbCrLf
    ...
    response.write "<tr><td height='50' align='center' colspan='9' nowrap  bgcolor='#EBF2F9'>暂无留言信息</td></tr>"
  end if
'-----------------------------------------------------------
'-----------------------------------------------------------
  Response.Write "<tr>" & vbCrLf
