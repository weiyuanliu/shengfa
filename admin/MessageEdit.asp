...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
    <td height="24" align="center" nowrap  bgcolor="#EBF2F9"><a href="MessageEdit.asp?Result=Add" onClick='changeAdminFlag("留言信息列表")'>添加留言信息</a><font color="#0000FF">&nbsp;|&nbsp;</font>
	<a href="MessageList.asp" onClick='changeAdminFlag("留言信息列表")'>查看留言信息</a><font color="#0000FF">&nbsp;|&nbsp;</font>
	<a href="SetSite.asp#Message" target="mainFrame" onClick='changeAdminFlag("网站信息设置")'>设置是否自动审核</a></td>
  </tr>
</table>
<br>
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
    <td height="24" nowrap bgcolor="#EBF2F9"><table width="100%" border="0" cellpadding="0" cellspacing="0" id=editProduct idth="100%">
	  ...
	  <tr>
        <td width="160" height="20" align="right">留言地区</td>
        <td><input name="Linkman" type="text" class="textfield" id="Linkman" style="WIDTH: 240;" value="<%=Linkman%>">&nbsp;*&nbsp;示例:北京市 电信</td>
      </tr>
      <tr>
        <td height="20" align="right">留言主题：</td>
        <td><input name="MesName" type="text" class="textfield" id="MesName" style="WIDTH: 240;" value="<%=MesName%>">&nbsp;*&nbsp;提示:必须超过3个字符!</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input name="Mobile" type="text" class="textfield" id="Mobile" style="WIDTH: 120" value="<%=Mobile%>" >&nbsp;*&nbsp;示例:218.30.101.122</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input name="AddTime" type="text" class="textfield" id="AddTime" style="WIDTH: 240" value="<%=AddTime%>"  >&nbsp;*&nbsp;时间格式:2015-08-11 12:00:00</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td valign="bottom"><input name="submitSaveEdit" type="submit" class="button"  id="submitSaveEdit" value="保存" style="WIDTH: 80;" >&nbsp;&nbsp;<input type="button" style="WIDTH: 80;" class="button" id="Modify2" value="返 回" onClick="window.history.go(-1);"></td>
      </tr>
      <tr>
...
<%
sub MesEdit()
  dim Action,rsCheckAdd,rs,sql,Editadmin
