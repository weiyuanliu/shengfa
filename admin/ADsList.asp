...
function PlaceFlag()
  if Result="Search" then
    Response.Write "广告：列表&nbsp;->&nbsp;检索&nbsp;->&nbsp;添加时间[<font color='red'>"&StartDate&"至"&EndDate&"</font>]，关键字[<font color='red'>"&Keyword&"</font>]"
  else
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
    <td height="36" align="center" nowrap  bgcolor="#EBF2F9"><table width="100%" border="0" cellspacing="0">
      <tr>
        <form name="formSearch" method="post" action="Search.asp?Result=ADs">
          <td nowrap> 广告检索：从
        ...
        <td align="right" nowrap><a href="ADsList.asp" onClick='changeAdminFlag("弹窗广告列表")'>弹窗广告列表</a><font color="#0000FF">&nbsp;|&nbsp;</font><a href="ADsEdit.asp?Result=Add" onClick='changeAdminFlag("添加弹窗广告")'>添加弹窗广告</a></td>
      </tr>
    </table>      </td>    
  </tr>
</table>
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
    ...
    <td nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>弹窗广告标题</strong></font></td>
    <td width="120" nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>弹窗尺寸</strong>（像素）</font></td>
    <td width="128" nowrap bgcolor="#8DB5E9"><strong><font color="#FFFFFF">发布时间</font></strong></td>
...
'-----------------------------------------------------------
  if(idcount>0 and sqlid<>"") then'如果记录总数=0,则不处理
    ...
    while(not rs.eof)'填充数据到表格
	  ...
	  if StrLen((rs("ADsName")))>51 then
        Response.Write "<td nowrap>"&StrLeft(rs("ADsName"),48)&"</td>" & vbCrLf
      else
        Response.Write "<td nowrap>"&rs("ADsName")&"</td>" & vbCrLf
      end if 
      ...
      Response.Write "<td width='48' nowrap><a href='ADsEdit.asp?Result=Modify&ID="&rs("ID")&"' onClick='changeAdminFlag(""修改弹窗广告"")'><font color='#330099'>修改</font></a></td>" & vbCrLf
    ...
    Response.Write "<td colspan='2' nowrap  bgcolor='#EBF2F9'><input name='submitDelSelect' type='button' class='button'  id='submitDelSelect' value='删除所选' onClick='ConfirmDel(""您真的要删除这些弹窗广告吗？"");'></td>" & vbCrLf
    Response.Write "</tr>" & vbCrLf
  else
    response.write "<tr><td height='50' align='center' colspan='10' nowrap  bgcolor='#EBF2F9'>暂无弹窗广告</td></tr>"
  end if
'-----------------------------------------------------------
'-----------------------------------------------------------
  Response.Write "<tr>" & vbCrLf
