...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
    ...
    <td width="150" nowrap bgcolor="#8DB5E9"><span class="STYLE1">地区</span></td>
    ...
    <td colspan="3" width="76" nowrap bgcolor="#8DB5E9"><strong><font color="#FFFFFF">操作</font></strong>
...
'-----------------------------------------------------------
  if(idcount>0 and sqlid<>"") then'如果记录总数=0,则不处理
    ...
    while(not rs.eof)'填充数据到表格
      ...
      Response.Write "<td nowrap align='center'>"&rs("Ediadmin")&"</td>" & vbCrLf
	  ...
	  if Instr(session("AdminPurview"),"|317,")<>0 then 
	  Response.Write "<td width='14' nowrap><input name='selectID' type='checkbox' value='"&rs("ID")&"' style='HEIGHT: 13px;WIDTH: 13px;'></td>" & vbCrLf
	  end if
      Response.Write "<td width='40' align='center' nowrap><a href='MsgDel.asp?Result=Modify&ID="&rs("ID")&"'><font color='#330099'>删除</font></a></td>" & vbCrLf
      Response.Write "</tr>" & vbCrLf
	  rs.movenext
    wend
    Response.Write "<tr>" & vbCrLf
    Response.Write "<td colspan='9' nowrap  bgcolor='#EBF2F9'>&nbsp;</td>" & vbCrLf
    Response.Write "<td colspan='3' nowrap  bgcolor='#EBF2F9' align='center'>"
	if Instr(session("AdminPurview"),"|317,")<>0 then 
