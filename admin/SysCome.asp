...
<table width="720" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
    ...
    <td width="40%" bgcolor="#EBF2F9">成都七日科技有限公司</td>
    <td width="10%" height="24" bgcolor="#EBF2F9">产品负责：</td>
    <td width="40%" bgcolor="#EBF2F9">七日科技技术部</td>
  </tr>
  <tr>
    <td width="10%" height="24" bgcolor="#EBF2F9">总机电话：</td>
    <td width="40%" height="24" bgcolor="#EBF2F9">028-68006558</td>
    <td width="10%" height="24" bgcolor="#EBF2F9">产品咨询：</td>
    <td width="40%" height="24" bgcolor="#EBF2F9">028-68006559 QQ(12466160) </td>
  </tr>
  <tr>
    <td width="10%" height="24" bgcolor="#EBF2F9">技术支持：</td>
    <td width="40%" height="24" bgcolor="#EBF2F9">028-68006559</td>
    <td width="10%" height="24" bgcolor="#EBF2F9">客服电话：</td>
    <td width="40%" height="24" bgcolor="#EBF2F9">028-68006559</td>
  </tr>
  <tr>
    <td height="24" bgcolor="#EBF2F9">传　　真：</td>
    <td height="24" bgcolor="#EBF2F9">028-68006558</td>
    <td height="24" bgcolor="#EBF2F9">电子邮件：</td>
    <td height="24" bgcolor="#EBF2F9">qisedao@163.com</td>
  </tr>
  <tr>
    <td height="24" bgcolor="#EBF2F9">官方网站：</td>
    <td height="24" bgcolor="#EBF2F9"><a href="http://www.qisehu.com" target="_blank">www.qisehu.com</a></td>
    <td height="24" bgcolor="#EBF2F9">演示站点：</td>
    <td height="24" bgcolor="#EBF2F9"><a href="http://test.lisuo.com" target="_blank">test.qisehu.com</a></td>
  </tr>
  <tr>
    <td height="24" bgcolor="#EBF2F9">帮助中心：</td>
    <td height="24" bgcolor="#EBF2F9"><a href="http://help.lisuo.com" target="_blank">help.qisehu.com</a></td>
    <td height="24" bgcolor="#EBF2F9">技术交流：</td>
    <td height="24" bgcolor="#EBF2F9"><a href="http://bbs.lisuo.com" target="_blank">bbs.qisehu.com</a></td>
  </tr>
  <tr>
    <td height="24" bgcolor="#D7E4F7">授权使用：</td>
    <td height="24" bgcolor="#D7E4F7">七日科技有限公司</td>
    <td height="24" bgcolor="#D7E4F7">版权所有</td>
    <td height="24" bgcolor="#D7E4F7"> 2004-2008 CopyRight <a href="http://www.qisehu.com" target="_blank">qisehu</a> Co.,LTD</td>
  </tr>
</table>
<%
