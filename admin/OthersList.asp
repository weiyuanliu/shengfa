...
function PlaceFlag()
  if Result="Search" then
    Response.Write "其他信息：列表&nbsp;->&nbsp;检索&nbsp;->&nbsp;添加时间[<font color='red'>"&StartDate&"至"&EndDate&"</font>]，关键字[<font color='red'>"&Keyword&"</font>]"
  else
    if SortPath<>"" then
      Response.Write "其他信息：列表&nbsp;->&nbsp<a href='OthersList.asp'>全部</a>"
	  TextPath(SortID)
	else
      Response.Write "其他信息：列表&nbsp;->&nbsp全部"
	end if
  end if
end function  
%>
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  <tr>
    <td height="24" nowrap><font color="#FFFFFF"><img src="Images/Explain.gif" width="18" height="18" border="0" align="absmiddle">&nbsp;<strong>其他信息检索及分类查看：添加，修改，删除其他信息</strong></font></td>
  </tr>
  <tr>
    <td height="36" align="center" nowrap  bgcolor="#EBF2F9"><table width="100%" border="0" cellspacing="0">
      <tr>
        ...
        <td align="right" nowrap>查看：<a href="OthersList.asp" onClick='changeAdminFlag("其他信息列表")'>全部信息</a><font color="#0000FF">&nbsp;|&nbsp;</font><a href="OthersSort.asp" onClick='changeAdminFlag("选择查看分类")'>其他类别信息</a></td>
      </tr>
    </table>      </td>    
  </tr>
</table>
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
    ...
    <td nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>信息名称</strong>（指向显示所属类别）</font></td>
    <td width="76" nowrap bgcolor="#8DB5E9"><strong><font color="#FFFFFF">查看组别</font></strong></td>
    <td width="120" nowrap bgcolor="#8DB5E9"><strong><font color="#FFFFFF">发布时间</font></strong></td><td width="10" nowrap bgcolor="#8DB5E9"><strong><font color="#FFFFFF">排序</font></strong></td>
...
'-----------------------------------------------------------
  if(idcount>0 and sqlid<>"") then'如果记录总数=0,则不处理
    ...
    while(not rs.eof)'填充数据到表格
	  ...
	  if StrLen((rs("OthersName")))>55 then
        Response.Write "<td nowrap title='类别：&#13;"&SortText(rs("SortID"))&"&nbsp;|&nbsp;"&rs("SortPath")&"'>"&StrLeft(rs("OthersName"),52)&"</td>" & vbCrLf
      else
        Response.Write "<td nowrap title='类别：&#13;"&SortText(rs("SortID"))&"&nbsp;|&nbsp;"&rs("SortPath")&"'>"&rs("OthersName")&"</td>" & vbCrLf
      end if 
      ...
      Response.Write "<td width='48' nowrap><a href='OthersEdit.asp?Result=Modify&ID="&rs("ID")&"' onClick='changeAdminFlag(""修改信息"")'><font color='#330099'>修改</font></a></td>" & vbCrLf
    ...
    Response.Write "<td colspan='2' nowrap  bgcolor='#EBF2F9'><input name='submitDelSelect' type='button' class='button'  id='submitDelSelect' value='删除所选' onClick='ConfirmDel(""您真的要删除这些信息吗？"");'></td>" & vbCrLf
    Response.Write "</tr>" & vbCrLf
  else
    response.write "<tr><td height='50' align='center' colspan='10' nowrap  bgcolor='#EBF2F9'>暂无其他信息</td></tr>"
  end if
'-----------------------------------------------------------
'-----------------------------------------------------------
  Response.Write "<tr>" & vbCrLf
