...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
    <td height="24" align="center" nowrap  bgcolor="#EBF2F9"><a href="AddCity.asp?Result=Add" onClick='changeAdminFlag("添加省份信息")'>添加市级信息</a><font color="#0000FF">&nbsp;|&nbsp;</font><a href="City.asp" onClick='changeAdminFlag("查看所有市级信息")'>查看所有市级信息</a></td>    
  </tr>
</table>
<br>
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  <form action="DelContent.asp?Result=City" method="post" name="formDel" >
    <tr>
      ...
      <td width="188" align="center"  bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>所属省份</strong></font></td>
      <td width="188" height="24" align="center"  bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>市名称</strong></font></td>
		...
		for i=1 to Page_Size 
			if not rs.eof then
				response.Write("<tr bgcolor='#EBF2F9'>")
					...
					response.Write("<td align='center'>")
						response.Write("【<a href='EditCity.asp?ID="&rs("ID")&"'>编 辑</a>】")
