...
if Action="AddRecord" then Call AddRecords()
%>
<BODY>
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
    ...
    <table width="87%" border="0" cellpadding="4" cellspacing="0">
     <form name="AddRegional" id="AddRegInonal" action="AddRegional.asp?Action=AddRecord" method="post" onSubmit="return Check_AddRegionalValues();">
      <tr>
        <td width="17%" align="right"><strong>区域名称：</strong></td>
        <td width="83%"><label>
          <input type="text" name="QY_Names" id="QY_Names">　
          *必填
        </label></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><label>
          <input type="text" name="QY_Type" id="QY_Type">
        　
          *必填
        </label></td>
      </tr>
      <tr>
        ...
        <td><label>
          <input type="text" name="QY_XingZhi" id="QY_XingZhi">
        　
          *必填
        </label></td>
      </tr>
      <tr>
        ...
        <td>
            <INPUT type="hidden" name="QY_FanWei" value="请在此添加文字说明内容！">
      ...
      <tr>
        ...
        <td>
        	<INPUT type="hidden" name="QY_Wai" value="请在此添加文字说明内容！">
      ...
      <tr>
        ...
        <td><label>
          <input type="radio" name="QY_CaoZuo" id="QY_CaoZuo" value="１" checked>
          是
         　 
         <input type="radio" name="QY_CaoZuo" id="QY_CaoZuo2" value="０">
          否
        </label></td>
      </tr>
      <tr>
        ...
        <td>
        	<INPUT type="hidden" name="QY_BeiZu" value="请在此添加备注内容！">
      ...
      <tr>
        ...
        <td><label>
          <input name="QY_AddTime" type="text" id="QY_AddTime" value="<%=Now()%>">
        </label></td>
      </tr>
      <tr>
        <td align="right"><strong>排序顺序：</strong></td>
        <td><label>
          <input name="QY_Px" type="text" id="QY_Px" size="10" value="0">
        　请填写数字排序信息，值越大排在越前</label></td>
      </tr>
      <tr>
        <td align="right">&nbsp;</td>
        <td><label>
          <input type="submit" name="tijiao" id="tijiao" value="添 加" style="margin-left:15px; margin-right:10px;">
...
Sub AddRecords()
	...
	Dim Rs,Sql
	Set Rs=Server.CreateObject("adodb.recordset")
	Sql="Select * from Regional where QY_Names='"&QY_Names&"' and QY_ShengFen="&QY_ShengFen&" and QY_City="&QY_City&" and QY_Citys="&QY_Citys
	Rs.open Sql,conn,1,1
	if Not rs.eof and Not rs.bof then
		rs.close()
		set rs=Nothing
		Call Message("对不起，记录不能重复添加，请返回！")
		response.End()
		exit sub
	end if
	rs.close
	Sql="Select top 1 * from Regional"
	...
	response.Write("<script language=javascript>"&vbcrlf)
		response.Write("alert('记录添加成功！');"&vbcrlf)
		response.Write("window.location.href='AddRegional.asp';")
