...
function PlaceFlag()
  if Result="Search" then
    Response.Write "供应：列表&nbsp;->&nbsp;检索&nbsp;->&nbsp;提交时间[<font color='red'>"&StartDate&"至"&EndDate&"</font>]，关键字[<font color='red'>"&Keyword&"</font>]"
  else
    Response.Write "供应：列表&nbsp;->&nbsp全部"
  end if
end function  
%>
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
	...
	<td align="right" nowrap>查看：<a href="SupplyList.asp" onClick='changeAdminFlag("供应信息列表")'>所有供应信息</a></td>
      </tr>
    </table>
	</td>    
  </tr>
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
    ...
    <td width="88" bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>供应者</strong></font></td>
    <td nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>供应商品名称</strong></font></td>
    <td width="156" nowrap bgcolor="#8DB5E9"><strong><font color="#FFFFFF">供应单位</font></strong></td>
...
'-----------------------------------------------------------
  if(idcount>0 and sqlid<>"") then'如果记录总数=0,则不处理
    ...
    while(not rs.eof)'填充数据到表格
      ...
      Response.Write "<td width='48' nowrap><a href='SupplyEdit.asp?Result=Modify&ID="&rs("ID")&"' onClick='changeAdminFlag(""查看回复供应信息"")'><font color='#330099'>查看.回</font></a></td>" & vbCrLf
    ...
    Response.Write "<td colspan='2' nowrap  bgcolor='#EBF2F9'><input name='submitDelSelect' type='button' class='button'  id='submitDelSelect' value='删除所选' onClick='ConfirmDel(""您真的要删除这些供应信息吗？"");'></td>" & vbCrLf
    Response.Write "</tr>" & vbCrLf
  else
    response.write "<tr><td height='50' align='center' colspan='8' nowrap  bgcolor='#EBF2F9'>暂无供应信息</td></tr>"
  end if
'-----------------------------------------------------------
'-----------------------------------------------------------
  Response.Write "<tr>" & vbCrLf
