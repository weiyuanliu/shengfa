<%
Dim dgtime,Sh_Name,Sh_Mobel,Sh_Tel,Sheng,shi,xian,Addres,RecordCounts,ZipCodes,QuType,XOrStr,AddersStr,OrderId
...
if Trim(Request.Form("Addres"))="" then
...
<div class="Order_Text" style="border:#0351A3 1px solid;background:#EEF7FE;margin:15px; width:60%; text-align:left;">
  ...
  <tr>
    ...
    <td width="79%" height="30"><span class="STYLE1">倍洛加
      <input type="hidden" name="ProdName" value="倍洛加" /></span></td>
  </tr>
  <tr>
