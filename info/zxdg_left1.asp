...
%>
        ...
        <table width="100%" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC"  class="ordertd">
                                        ...
                                        <tr>
                                            <td width="18%" align="center" rowspan="2" >商品类型:</td>
                                             <td width="36%" class="otderpa"><input class="inputone" maxlength="60" size="32" name="ProductName1" id="ProductName1" value="体验装1支(398元/盒)" style="width:180px;" readonly="readonly" /><font color="red">*</font></td><td width="46%">商品数量:&nbsp;<select name='Numbers1' size='1' id='Numbers1' onchange="jisuan()"><option value='NULL' selected>请选择数量</option><option value='体验装1支(0)'>0盒</option><option value='体验装1支(1)'>1盒</option><option value='体验装1支(2)'>2盒</option><option value='体验装1支(3)'>3盒</option><option value='体验装1支(4)'>4盒</option><option value='体验装1支(5)'>5盒</option></select><font color="red">*</font></td></tr><tr><td width="36%" class="otderpa"><input class="inputone" maxlength="60" size="32" name="ProductName2" id="ProductName2" value="改善装2支(598元/盒)" style="width:180px;" readonly="readonly" /><font color="red">*</font></td><td width="46%">商品数量:&nbsp;<select name='Numbers2' size='1' id='Numbers2' onchange="jisuan()"><option value='NULL' selected>请选择数量</option><option value='改善装2支(0)'>0盒</option><option value='改善装2支(1)'>1盒</option><option value='改善装2支(2)'>2盒</option><option value='改善装2支(3)'>3盒</option><option value='改善装2支(4)'>4盒</option><option value='改善装2支(5)'>5盒</option></select><font color="red">*</font></td></tr><input type='hidden' name='RecordCount' id='RecordCount' value='2'>
	...
	<%if GetValues("NwebCn_About","Content",61) <> "" then%>
           <div class="oderpay">
	<%=GetValues("NwebCn_About","Content",67)%>
