...
function savedingdan()
	...
	sql="insert into NwebCn_Order (ProductName,AddTime,Linkman,Address,ZipCode,Telephone,Amount,ProductNo,tel,Remark,ADS_Link) VALUES('"&ProdName&"','"&AddTime&"','"&Sh_Name&"','"&AddresStr&"','"&ZipCodes&"','"&Sh_Mobel&"','"&Products&"','"&ProductNo&"','"&Sh_Tel&"','"&Remark&"',"&ADS_Link&")"
...
'货到付款
	response.Write("<div style='width:400px; height:300px; background:#ffffff; padding:10px; border:#000000 1px solid;'>")
		...
		response.Write("<div style='padding-top:10px;'>")
			response.Write("<input type='button' name='getbak' id='getbak' value='返 回' style='border:#ff0000 1px solid; font-size:14px; padding-top:3px;' onclick=""window.location.href='Index.asp';"">")
		response.Write("</div>")
	response.Write("</div>")
End sub
