...
Sub Ok()
'货到付款
	response.Write("<div class='success' style='width:90%; height:300px; background:#ffffff; padding:10px; border:#000000 1px solid;'>")
...
%>
<style>.success img{max-width:100%;}</style>
</body>
</center>
</html>