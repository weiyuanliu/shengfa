...
<TABLE cellSpacing="1" cellpadding="1" width="90%"  align=center >
    <form name="Save_Order" id="Save_Order" method="post" action="TgSaveOrder.asp">
  ...
  <tr><td colspan='2' class="orderok_t">请仔细核对订单信息</td></tr>
    ...
    <TR>
    	...
    	<TD><input type="text" style="width:300px;" name="AddresStr" value="<%=(AddersStr&Addres)%>" /> <br/>地址栏内容可修改</TD>
    </TR>
    <TR>
