  ...
  <tr>
    <td width="830" valign="top">
      <table width="830" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="2000" valign="top" class="bk_xb1 bk_zb bk_yb"><table width="721" border="0" cellpadding="0" cellspacing="0" class="mag">
            <tr>
              <td height="15">&nbsp;</td>
            </tr>
            <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td height="107"><table width="830" border="0" cellspacing="0" cellpadding="0">
              <tr>
              ...
              <tr>
                <td style="padding:5px;">
                 <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td width="100" height="30" class="text5">订货人姓名：</td>
                    <td width="170"><input type="text" name="KeyWord" style="width:150px;height:26px;border:1px solid #999;margin:10px auto;" value=""/></td>
                    <td width="100" rowspan="2"><table border="0" cellspacing="0" cellpadding="0">
                      <tr>
				  ...
				  <!--
				  <tr>
				  <td width="100" height="30" class="text5">请输入验证码：</td>
				  <td width="170">
				  <INPUT name="VerifyCode" type=text style="width:100px;height:26px;margin:10px auto;" class=or id="LoginPassword">&nbsp;&nbsp;<img src="../Include/VerifyCode.asp" alt="看不清楚?请点击刷新" onclick="this.src=this.src+'?'+Math.random();" align="absmiddle" style="CURSOR:hand;">
				  </td>
				  </tr>
				  -->
                  </form>
        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <table width="830" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td width="100" height="25" align="left">您订货时提交的姓名：</td>
                <td width="230" height="25" colspan="2" align="left"><input name="UserName" id="UserName" style="width:100px;height:26px;border:1px solid #999;margin:10px auto;" />
                  <font color="ff0000">*</font>请填写真实信息</td>
		<td width="260"></td>
              </tr>
              <tr>
                <td width="100" height="25" align="left">订货的大概时间：</td>
                <td width="260" colspan="2" align="left"><input type="text" style="width:50px;height:26px;border:1px solid #999;margin:10px auto;" name="Year" id="Year" value="" /> 年 <input type="text" style="width:26px;height:26px;border:1px solid #999;margin:10px auto;" name="Month" id="Month" value="" /> 月 <input type="text" style="width:26px;height:26px;border:1px solid #999;margin:10px auto;" name="Day" id="Day" value="" /> 日 xx年xx月x日</td>
              </tr>
              <tr>
                <td width="100" height="25" align="left">您的联系电话：</td>
                <td width="100" colspan="2" height="25" align="left"><input type="text" style="width:100px;height:26px;border:1px solid #999;margin:10px auto;" name="TelPhone" id="TelPhone" /></td>
              </tr>
			  <tr>
                <td width="100" height="25" align="left">请输入验证码：</td>
                <td width="170" height="25" align="left">
				<input type="text" name="check_left" id="check_left" size="6" maxlength="4" class="inputone" />&nbsp;<img src="Include/newcode_left.asp" alt="验证码看不清楚?请点击刷新验证码!" title="验证码看不清楚?请点击刷新验证码!" height="22" style="cursor:pointer;margin-bottom:-6px;" onClick="this.src='Include/newcode_left.asp?t='+(new Date().getTime());" ></td>
      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td>
            <table width="830" border="0" cellspacing="0" cellpadding="0" id="S">
                <tr>
		...
		<td height="32" align="left">下面是反馈回来的快递信息：</td>
                    ...
                    <tr>
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          <td width="80" height="32" class="text10">电话号码：</td>
                          <td width="200"><input type="text" name="TelPhone" id="TelPhones" style="width:200px;height:26px;border:1px solid #999;margin:10px auto;" value="<%=Trim(Request("TelPhone"))%>" /></td>
                          <td width="50" align="center">&nbsp;<font color="ff0000">*</font>必填</td>
                          <td width="77"><table border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="77" height="24" class="text7"><input type="submit" class="tijiao" value="点击查询" /></td>
                              </tr>
                          </table></td>
         ...
         <%
			...
			Select Case Action
				...
				Case "Search_Phone":
					ViewText	
				Case Else%>
				<div class="search_tit">最新发货通知</div>				<div style="height:auto; width:100%; margin-top:10px; line-height:26px; color:#030303; padding:10px; text-align:left;">
						<%
                            DIm Object
...
function CheckMsg2()
{
	var UserName,TelPhone,Year,Month,Day,ShiJian,yz;
