   <div id="footer">
  <div class="corpright">
 公司：古那迪國際集團(香港)控股有限公司&nbsp;&nbsp;&nbsp;&nbsp;地址：（总部）香港九龍旺角道<br>&nbsp;&nbsp;&nbsp;&nbsp;        &nbsp;&nbsp;&nbsp;&nbsp;<br>        &nbsp; &nbsp; <br>
 </div>
...
<div id="msg_win" style="display:block;visibility:visible;position:absolute;right:2;opacity:1;">
    ...
    #msg_title{background:#212142;border-bottom:1px solid #A67901;color:#FFF;height:25px;line-height:25px;text-indent:5px;}
...
if request.Cookies("advlink") <> 0 then  'ZENGGAOXING
 dim asql,ars
